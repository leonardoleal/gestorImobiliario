				...
				<div class="block_content">
					...
					<form method="post" action="<?php html::write( $page[ 'url' ] ); ?>update/" enctype="multipart/form-data">
						...
						<p>
							<label>
                            	<span>Locador:</span>
								<select name="renter_id" class="styled">
									<option value="">Selecione um cliente</option>
									<?php foreach( $customers as $customer ) { ?>
									<option value="<?php html::write( $customer->id ); ?>" <?php html::write( html::is_selected( $fields[ 'renter_id' ] == $customer->id ) ); ?>><?php html::write( $customer->name ); ?></option>
									<?php } ?>
								</select>
							</label>
						</p>
						...
						<p>
							<label>
								...
								<select name="state_id" class="styled">
									...
									<option value="<?php html::write( $state->id ); ?>" <?php html::write( html::is_selected( $state->id == $fields[ 'state_id' ] ) ); ?>><?php html::write( $state->alias ); ?></option>
									<?php } ?>
								</select>
							</label>
						</p>
