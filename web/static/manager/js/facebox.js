...
var loadingImage = config.manager.static_url + 'img/loading.gif';
var closeImage   = config.manager.static_url + 'img/closelabel.gif';
          ...
          <tbody> \
            ...
            <tr> \
              ...
              <td class="body"> \
                ...
                <div class="footer"> \
                  <a href="#" class="close"> \
                    <img src="' + closeImage + '" title="close" class="close_image" /> \
                  </a> \
                </div> \
              </td> \
              <td class="b"/> \
